...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        // private GameManager leaderboardUpdate;
        ...
        void Start()
        {
            ...
            // leaderboardUpdate=FindAnyObjectByType<GameManager>();
        if (view.IsMine) 
        {
            reduced=false;
            tr=GetComponent<Transform>();
        GetComponentInChildren<Camera>().enabled = true; // Enable camera for local player
        GetComponentInChildren<AudioListener>().enabled = true; // Enable audio listener
        }
        else
        {
        GetComponentInChildren<Camera>().enabled = false; // Disable camera for remote players
        ...
        { if(view.IsMine){
            // check for Y kill
            if (!IsDead && tr.position.y < KillHeight)
            {
        ...
        void OnControllerColliderHit(ControllerColliderHit hit)
        {
            ...
            if(hit.gameObject.CompareTag("Hell")){
                Debug.Log("Mar gya");
                OnDie();
            }
        ...
        {
            IsDead=true;
            tr.position = spawnPoint.transform.position;
            Debug.Log("Player Dead");
            m_Health.Heal(100);
            reduced=true;
            Debug.Log("Score will be reduced by 10 points and Health will be restored");
            IsDead = false;
        ...
        void UpdateCharacterHeight(bool force)
        {
            ...
            if (force)
            {
                ...
                m_Actor.AimPoint.transform.localPosition = new Vector3(0,0.85f,0)+m_Controller.center;
            }
